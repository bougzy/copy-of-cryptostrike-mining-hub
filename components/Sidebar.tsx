...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange, session, onLogout, isCollapsed, onToggleCollapse, isMobileOpen, onCloseMobile }) => {
    ...
    <>
      ...
      `}>
        ...
        <button
          ...
          className="absolute -right-3 top-20 w-6 h-6 bg-slate-800 border border-slate-700 rounded-full items-center justify-center text-slate-400 hover:text-white hover:bg-slate-700 transition-colors z-50 hidden lg:flex"
        ...
        <button
          onClick={onCloseMobile}
          className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center text-slate-400 hover:text-white lg:hidden"
        >
